...
System WebView builds are available on macOS, Linux, and Windows. Chromium/CEF builds and packages are macOS-first, with Linux Chromium still limited. Native controls are supported on macOS, Linux, and Windows system-WebView hosts.
